...
data:extend({
  {
    ...
    minable = {mining_time = 0.25, result = "rubia-wind-turbine"},
    max_health = 200,
  ...
  },
  {
    ...
    name = "rubia-wind-turbine-generator",
    localised_name = {"entity-name.rubia-wind-turbine"},
    localised_description = {"entity-description.rubia-wind-turbine"},
  ...
  {
    type = "electric-pole",
    name = "rubia-wind-turbine-source",
  ...
  {
    type = "electric-pole",
    name = "rubia-wind-turbine-transmitter",
    icon = "__base__/graphics/icons/small-electric-pole.png",
    icon_size = 64,
    localised_name = {"entity-name.rubia-wind-turbine"},
    localised_description = {"entity-description.rubia-wind-turbine"},
    flags = {"not-repairable", "not-blueprintable", "not-deconstructable"},
    hidden = true,
    placeable_by = {item = "rubia-wind-turbine", count = 1},
